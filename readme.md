...
This repository and the NPM packages produced by it are deprecated.

See https://github.com/geneontology/web-components for ongoing GO wc-gocam-viz (GO-CAM pathway visualization) development.
